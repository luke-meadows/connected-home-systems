export const faqs = [
  {
    ...
    answer:
      'Almost any technology can be installed into any property but it will require a good network to ensure it performs correctly. A network is best described',
