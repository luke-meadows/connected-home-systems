export const faqs = [
  {
    question: 'What tech can I have installed in my house?',
    answer:
      'Almost any technology can be installed into any property but it will require a good network to ensure it performs correctly.  A network is best described here ( HYPERLINK go to the network section).',
  },
  {
    question:
  ...
  {
    question: 'Can I control all my tech from one device?',
    answer:
  ...
  {
    question: 'Who would program my automation?',
    answer:
  ...
  {
    question: 'Can Connected Home systems work with my interior designer?',
    answer:
  ...
  {
    question: 'Can I use connected home systems on new builds?',
    answer:
