...
import Network from '../public/imgs/service-imgs/network1.jpg';
import Cinema from '../public/imgs/service-imgs/cinema.png';
import Multiroom from '../public/imgs/service-imgs/multiroom.jpg';
import Service from '../public/imgs/service-imgs/rack.jpg';
export const servicesData = [
  {
    ...
    bullets: [
      ...
      'We work with lighting designers',
    ],
    seo: {
      title: 'Connected Home Systems -  Smart Lighting, with energy savings',
      desc: 'Smart lighting will subtly, but effectively, influence the ambiance of your home, complementing the aesthetics of its décor.  Contact Connected Home Systems to learn more.',
    },
  },
  {
    ...
    seo: {
      title: 'Connected Home Systems - Design and Consultancy Service',
      desc: 'We complete fully costed designs to work with your builder / architect.  Offering advice and solutions for your home',
    },
  },
  {
    title: 'Networks',
    ...
    seo: {
      title: 'Connected Home Systems - Networking service and servers',
      desc: 'Powering the home of the future.  Hardwiring as much as possible with blanket coverage Wi-Fi for your entire property.',
    },
  },
  {
    title: 'Smart Home',
    ...
    seo: {
      title: 'Connected Home Systems -  Smart home design and Install',
      desc: 'A truly smart home should be intuitive and effortless. We make it work for you',
    },
  },
  {
    ...
    seo: {
      title: 'Connected Home Systems -  Home Cinema',
      desc: 'Transform unused space to a well-used space - Cinema room design service covering screen size, seating distance and acoustics',
    },
  },
  {
    title: 'Multiroom',
    ...
    seo: {
      title:
        'Connected Home Systems - Music and Video wherever you are or want to be',
      desc: 'Finest quality sound, following you around the house as you live you best life. All automated, integrated and as subtle as you want it to be.',
    },
  },
  {
    ...
    seo: {
      title: 'Connected Home Systems - Routine servicing, suited to you.',
      desc: 'Bespoke aftercare service for you and your smart home, ensuring all is working as it should, replacing batteries, checking for updates, giving you peace of mind.',
    },
  },
];
