    ...
    <StyledAbout>
      ...
      <div>
        <p>
          ...
          built long term relationships with hundreds of clients who benefit
          from our innovation, experience and expertise.
        </p>
        <p>
        ...
        <p>
          ...
          home can turn on when you enter a room and off again when you leave
          and your heating knows when and how you like the temperature set by
          learning your routines. These are just some of the capabilities of a
          smart home which are achievable through independent products and
          multiple interfaces but our aim is to make the smart home a simple
          home.
        </p>

        <p>
          Simple to use, a truly smart home should be intuitive and effortless.
          No more switching from one app to another or multiple remote controls
          cluttering up the coffee table. It can monitor and change according to
          the internal and external environment. Multiple events can occur at
          the press of a single button. We can design systems that enable
          control over every aspect of a smart home from a single user
          interface, these systems are fully adaptable so as things change the
          system can be reprogrammed to suit.
        </p>
        <p>
          All of this technology is all well and good, but it relies on a solid
          backbone. If the infrastructure it is using to communicate is not up
          to standard then undoubtedly it will fail or there may be constant
          issues. We are passionate about cabling and we truly understand the
